...
아래 케이스 스터디 콘텐츠를 검증하라. 반드시 아래 JSON 형식으로만 응답하라. 다른 텍스트 없이 JSON만 출력하라.
...
### Green Flags (인간적 콘텐츠 필수 요소) - 3개 이상 충족 필요
1. 창업자의 직접 인용문
...
### E-E-A-T 점검
- Experience: 1차 소스 기반인가? 분석과 해석 포함? 한국 시장 고유 인사이트?
...
- 최소 2개 이상의 외부 링크 필요 (예: [Stripe](https://stripe.com), [Notion](https://notion.so))
